    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col items-center text-center rounded-lg border border-border bg-card p-6 shadow-sm">
                    <Snowflake
                ...
                <div className="flex flex-col items-center text-center rounded-lg border border-border bg-card p-6 shadow-sm">
                    ...
                    aria-hidden="true"
                     />
                    <h3 className="mt-4 text-xl font-bold font-serif">Heating</h3>
                    <p className="mt-2 text-sm text-muted-foreground">Reliable warmth for the colder months ahead.</p>
                </div>
                <div className="flex flex-col items-center text-center rounded-lg border border-border bg-card p-6 shadow-sm">
                    <Wrench
                    className="size-12 text-primary"
                    ...
                    aria-hidden="true"
                     />
                    <h3 className="mt-4 text-xl font-bold font-serif">Seasonal Maintenance</h3>
                    <p className="mt-2 text-sm text-muted-foreground">Keeps your system running best year after year.</p>
                </div>
            </div>
